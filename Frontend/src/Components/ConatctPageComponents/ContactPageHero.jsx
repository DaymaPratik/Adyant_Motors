...
function ContactPageHero() {
  ...
  return (
  <>
    <main className="relative h-fit min-h-[70vh] max-xlg:pt-[100px] md:min-h-[90vh] w-[100%] flex flex-col justify-center items-center gap-1 text-center text-white
   ...
   bg-no-repeat bg-center bg-cover">
    ...
    <h1 className="text-[35px] md:text-[50px] font-extrabold " data-aos="fade-left">Contact Us</h1>
