...
function CsrImages({large,setLarge,settingLarge}) {
    useEffect(()=>{
  ...
  return (
   <>
    <section  className='grid relative grid-cols-1 xs:grid-cols-2 md:grid-cols-3 gap-5 p-2 m:p-5 w-[98d%] md:w-[80%] mx-auto'  data-aos="fade-left" onClick={settingLarge}>
