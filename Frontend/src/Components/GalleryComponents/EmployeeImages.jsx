...
function EmployeeImages({large,setLarge,settingLarge}) {
    useEffect(()=>{
  ...
  return (
   ...
   <img src="/empmotivation/empmotivation.jpeg" 
   alt="" onClick={handleLarge} className='block h-[200px] min-[400px]:h-[300px] w-full'/>
   <img src="/empmotivation/empmotivation1.jpeg" 
   alt="" onClick={handleLarge} className='block h-[200px] min-[400px]:h-[300px] w-full'/>
   <img src="/empmotivation/empmotivation2.jpeg" 
   alt="" onClick={handleLarge} className='block h-[200px] min-[400px]:h-[300px] w-full'/>
   <img src="/empmotivation/empmotivation3.jpeg" 
   alt="" onClick={handleLarge} className='block h-[200px] min-[400px]:h-[300px] w-full'/>
   <img src="/empmotivation/empmotivation4.jpeg" 
   alt="" onClick={handleLarge} className='block h-[200px] min-[400px]:h-[300px] w-full'/>
   <img src="/empmotivation/empmotivation5.jpeg" 
   alt="" onClick={handleLarge} className='block h-[200px] min-[400px]:h-[300px] w-full'/>
