...
function GalleryHero() {
  ...
  return (
    ...
    bg-[url('https://images.unsplash.com/photo-1524947996703-8b011401c9e9?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]
    bg-no-repeat bg-center bg-cover">
 
     <h1 className="text-[35px] min-[756px]:text-[50px] font-extrabold " data-aos="fade-left">Gallery</h1>
