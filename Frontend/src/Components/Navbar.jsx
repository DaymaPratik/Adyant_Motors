...
function Navbar() {
  ...
  return (
   <nav className="flex justify-between items-center w-[100%] bg-[#0d0d0da4] z-[10] text-white py-1 px-[20px] min-[768px]:px-[50px] min-[1256px]:px-[100px]  fixed">
    <div>
    ...
    <ul className="flex justify-center  items-center gap-2 min-[]1256px:gap-5 px-5 text-[23px] min-[1256px]:text-[25px] font-semibold max-[1024px]:hidden">
        ...
        <li  className="border-2 border-transparent hover:text-[#ff0000] cursor-pointer hover:border-b-[#ff0000] transition duration-150 ease-in p-2">About Us</li>
        ...
        <li  className="border-2 border-transparent hover:text-[#ff0000] cursor-pointer hover:border-b-[#ff0000] transition duration-150 ease-in p-2">Newsroom</li>
