...
function HomeHeroSection() {
  ...
  return (
   <main className="relative h-fit min-h-[70vh] min-[756px]:min-h-[100vh] w-[100%] flex flex-col justify-center items-center gap-1 text-center text-white
   ...
   bg-no-repeat bg-center bg-cover">
    ...
    <div className="text-[20px] min-[756px]:text-[25px]  font-semibold gap-10 text-animate p-3 flex justify-center items-center mt-10" data-aos="fade-up">
