...
function HomeServicesSection() {
  ...
  return (
    <main className="flex justify-center items-center w-[100%] mx-auto  h-screen ">
      <section className="w-[100%] max-[1024px]:text-white max-[1024px]:bg-[url('https://images.unsplash.com/photo-1533666834526-903b11416fc1?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-no-repeat bg-cover bg-center max-[1024px]:mx-auto min-[1024px]:w-[50%] font-semibold text-[20px]  pl-[20px]">
      ...
      <figure className="max-[1024px]:hidden w-[50%] h-[100%]">
        <img src="../public/gear.avif" alt="" className="h-[100%]" data-aos="fade-left"/>
      </figure>
    </main>
  );
}
