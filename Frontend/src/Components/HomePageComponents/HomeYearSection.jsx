...
function HomeYearSection() {
  ...
  return (
    <main className={`w-[100%] bg-[#000000] mx-auto mt-[50px] flex justify-end items-end h-fit min-h-screen text-[12px] min-[768px]:text-[17px] font-semibold  gap-1 text-white relative 
    ...
    `} >
       {showYear[0] && 
        ...
        <div className={`border-[1px] border-white p-2 min-[768px]:p-4 h-fit ${showYear[0] ?  'bg-blue-400 border-none' :  'bg-[#0000005e]'} transititon duration-150 ease-in`}>
        ...
        <div className={`border-[1px] border-white p-2 min-[768px]:p-4 h-fit ${showYear[1] ?  'bg-blue-400  border-none' :  'bg-[#0000005e]'} transititon duration-150 ease-in`}>
        ...
        <div className={`border-[1px] border-white p-2 min-[768px]:p-4 h-fit ${showYear[2] ?  'bg-blue-400  border-none' :  'bg-[#0000005e]'} transititon duration-150 ease-in`}>
        ...
        <div className={`border-[1px] border-white p-2 min-[768px]:p-4 h-fit ${showYear[3] ?  'bg-blue-400 border-none' :  'bg-[#0000005e]'} transititon duration-150 ease-in`}>
