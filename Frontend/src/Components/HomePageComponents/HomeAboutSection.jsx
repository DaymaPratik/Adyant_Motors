...
function HomeAboutSection() {
  ...
  return (
    <main className="h-fit min-h-screen w-full  flex flex-col justify-center items-center my-[50px]">
      ...
      <section className="max-[768px]:flex-col flex justify-center my-[50px]  items-center w-[100%] min-[1024px]:w-[90%] min-[1256px]:w-[85%] mx-auto gap-[5%]">
        <p  className="max-[768px]:text-center p-3 text-[15px] min-[500px]:text-[17px] min-[1024px]:text-[20px] w-[90%] max-[768px]:mx-auto min-[768px]:w-[60%] min-[1024px]:w-[50%] ">
        ...
        <figure  className="w-[85%] max-[768px]:mx-auto min-[768px]:w-[30%] min-[1024px]:w-[40%] relative">
