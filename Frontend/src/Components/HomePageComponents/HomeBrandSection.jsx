...
function HomeBrandSection() {
  ...
  return (
   <section className="flex max-[956px]:flex-col justify-center py-5 items-center mx-auto w-[100%] min-[1024px]:w-[95%] min-h-screen h-fit ">
    <figure className="relative w-[80%] m-5 min-[956px]:w-[40%]" data-aos="fade-left">
    ...
    <div className="flex max-[956px]:mt-[40px] flex-col justify-center w-[90%] max-[956px]:mx-auto min-[956px]:w-[60%] min-[1024px]:w-[55%] gap-1 min-[600px]:gap-3 text-[17px] pl-2 min-[600px]:pl-10" data-aos="fade-right">
      <p className="text-[17px] min-[600px]:text-[20px] uppercase font-semibold text-blue-500">Building strategic partnerships with industry leaders.</p>
      <h5 className="text-[25px] min-[600px]:text-[35px] font-bold">Our Brand Partners</h5>
