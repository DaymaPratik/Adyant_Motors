...
function BrandsIntro() {
  ...
  return (
    ...
    <div className="flex lg:mt-[20px] flex-col justify-center w-[90%] max-lg:mx-auto lg:w-[60%] xlg:w-[55%] gap-1 sm:gap-3 text-[17px] pl-2 sm:pl-10" data-aos="fade-right">
      <p className="text-[15px] xs:text-[17px] sm:text-[20px] uppercase font-semibold text-blue-500">Building strategic partnerships with industry leaders.</p>
      <h5 className="text-[20px] xs:text-[25px] sm:text-[30px] font-bold">Our Brand Partners</h5>
      <p className="font-semibold p-2 text-[13px] sm:text-[15px]">
    ...
    <div className="flex lg:mt-[20px] flex-col py-[60px] text-white justify-center w-[90%] max-lg:mx-auto lg:w-[60%] xlg:w-[55%] gap-1 
    sm:gap-3 text-[17px] pl-2 sm:pl-10 bg-center bg-no-repeat bg-cover 
